...
<body class="{block 'body-class'}{str_replace('/', '_', $.responseId)}-tpl{/block}">
    ...
    <div style="width: 85%; margin: 1em auto; padding: 0.5em; background-color: yellow; border-radius: 5px; text-align: center; border: 1px dashed black;">
        This site is a preview of the next major version of Slate, it is synchronized to the live database nightly so <strong>any changes you make here will be lost</strong>.
    </div>
